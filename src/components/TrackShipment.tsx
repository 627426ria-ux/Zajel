  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8 sm:mb-10 max-w-[500px] px-2">
        ...
        <p className="text-[#064423]/60 text-xs sm:text-sm font-light leading-relaxed whitespace-normal sm:whitespace-pre-line">
      ...
      <div className="w-full max-w-[640px] bg-white rounded-[1.25rem] sm:rounded-[1.75rem] border border-[#E5EBE7] shadow-[0_8px_30px_rgba(6,68,35,0.04)] p-4 sm:p-6 md:p-8">
        ...
        <div className="flex p-1.5 bg-[#F0F4F2] rounded-full mb-6 sm:mb-8 relative">
          ...
          >
            ...
            {t('trackShipment.tabs.mobile')}
          </button>
        </div>

        {/* Input Group */}
        <div className="flex flex-col mb-5 sm:mb-6">
          <label className="text-[12px] sm:text-[13px] font-normal text-[#064423] mb-2.5 sm:mb-3 mx-1">
            {activeTab === 'awb' ? t('trackShipment.labels.awb') : t('trackShipment.labels.mobile')}
          </label>
          <input 
            type="text"
            value={inputValue}
            onChange={(e) => setInputValue(e.target.value)}
            placeholder={activeTab === 'awb' ? t('trackShipment.placeholders.awb') : t('trackShipment.placeholders.mobile')}
