...
import { supabase } from '../supabase'; // adjust path to your actual src/supabase.ts location
...
const CareersHeroMain: React.FC = () => {
  const [content, setContent] = useState<CareersHeroData | null>(null);
  const [enabled, setEnabled] = useState(true);
  const lang: 'en' | 'ar' = 'en'; // swap this for your real lang context/hook
  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <img
          src={content.image_url || '/image copy 13.png'}
          alt="Zajel Team"
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-[720px] mx-auto">
        <motion.h1
          ...
          className="text-white text-[2.5rem] md:text-[3rem] lg:text-[3.5rem] font-medium leading-[1.1] tracking-tight mb-6 whitespace-pre-line"
        >
          {content.title}
        </motion.h1>
