...
className="max-w-[1400px] w-full mx-auto relative overflow-hidden
                    h-[85svh] sm:h-[60svh] lg:h-[70svh]
                    flex items-end shadow-lg rounded-[2rem] lg:rounded-[2.5rem]"
>
{/* LAYER 1: Background Image */}
<div
className="absolute inset-0 w-full h-full bg-cover bg-center bg-no-repeat z-0"
style={{ backgroundImage: "url('/ChatGPT Image Apr 24, 2026 at 01_22_49 PM.png')" }}
/>
{/* LAYER 2: Gradient */}
...
<h1 className="text-white font-light leading-[1.05] tracking-tight
                         ...
                         mb-3 md:mb-4">
            Domestic <br /> Courier Service
</h1>
<p className="text-white/75 font-extralight leading-relaxed
                        text-[12px] sm:text-[14px] lg:text-[16px]
                        mb-6 md:mb-8 max-w-[400px]">
            Seamless domestic delivery with full tracking, powered by a fleet of 100+ vans and bikes, trusted by eCommerce, SMEs, and government for express delivery within 24 hours.
</p>
